            ...
            <div class="row">
               <div class="col-md-4">
                  <div class="mb-3">
                     ...
                     <input type="text" name="fname" class="form-control" id="fname" placeholder="Enter First name" onkeypress='return (event.charCode != 32)' value="{{$worker->fname}}" required>
                     @if($errors->has('fname'))
               ...
               <div class="col-md-4">
                  <div class="mb-3">
                     ...
                     <input type="text" name="lname" class="form-control" id="lname" placeholder="Enter Last Name" onkeypress='return (event.charCode != 32)' value="{{$worker->lname}}" required>
                     @if($errors->has('lname'))
            ...
            <div class="row">
               <div class="col-lg-4">
                  <div class="mb-3">
                     ...
                     <input type="number" name="mobile" class="form-control" id="mobile" placeholder="Enter number" value="{{$worker->mobile}}">
               ...
               <div class="col-lg-4">
                  <div class="mb-3">
                     ...
                     <input type="text" name="aadhar_no" class="form-control" id="aadhar_no" placeholder="Enter aadhar no" oninput="formatAadharInput(this)" value="{{$worker->aadhar_no}}">
               ...
               <div class="row">
                  ...
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <input type="number" name="{{ $roundworkerrang->key }}" class="form-control" id="{{ $roundworkerrang->key }}" placeholder="Enter amount" value="{{ $workerrateValues[$roundworkerrang->key] ?? '' }}">
               ...
               <div class="row">
                  ...
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <input type="number" name="{{ $otherworkerrang->key }}" class="form-control" id="{{ $otherworkerrang->key }}" placeholder="Enter amount" value="{{ $workerrateValues[$otherworkerrang->key] ?? '' }}">
               ...
               <div class="row">
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <input type="text" name="bank_name" class="form-control" id="bank_name" placeholder="Enter bank name" value="{{$worker->bank_name}}">
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="ifsc_code">IFSC code</label>
                        <input type="text" name="ifsc_code" class="form-control" id="ifsc_code" placeholder="Enter IFSC code" value="{{$worker->ifsc_code}}">
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="account_holder_name">Account Holder name</label>
                        <input type="text" name="account_holder_name" class="form-control" id="account_holder_name" placeholder="Enter Account Holder name" value="{{$worker->account_holder_name}}">
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="account_no">Account Number</label>
                        <input type="number" name="account_no" class="form-control" id="account_no" placeholder="Enter Account number" value="{{$worker->account_no}}">
                     </div>
                  </div>
               </div>
            </div>
