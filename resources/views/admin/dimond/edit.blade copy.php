   ...
   <div class="col-lg-12 mx-auto">
      <div class="card">
         <div class="card-body">
            ...
            <!--         <input type="date" name="created_at" class="form-control" id="created_at" value="{{ old('created_at', $dimond->created_at ? \Carbon\Carbon::parse($dimond->created_at)->format('Y-m-d') : '') }}" required>-->
